...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImGuiPlatformImeDataPtr
    {
        ...
        public ref bool WantVisible => ref UnsafeUtility.AsRef<bool>(&NativePtr->WantVisible);
        public ref Vector2 InputPos => ref UnsafeUtility.AsRef<Vector2>(&NativePtr->InputPos);
        public ref float InputLineHeight => ref UnsafeUtility.AsRef<float>(&NativePtr->InputLineHeight);
        public void Destroy()
        {
