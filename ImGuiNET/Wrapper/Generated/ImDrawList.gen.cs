...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImDrawListPtr
    {
        ...
        public ref ImDrawCmdHeader _CmdHeader => ref UnsafeUtility.AsRef<ImDrawCmdHeader>(&NativePtr->_CmdHeader);
        public ref ImDrawListSplitter _Splitter => ref UnsafeUtility.AsRef<ImDrawListSplitter>(&NativePtr->_Splitter);
        public ref float _FringeScale => ref UnsafeUtility.AsRef<float>(&NativePtr->_FringeScale);
