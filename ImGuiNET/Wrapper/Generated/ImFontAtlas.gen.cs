...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImFontAtlasPtr
    {
        ...
        public ref bool TexReady => ref UnsafeUtility.AsRef<bool>(&NativePtr->TexReady);
        public ref bool TexPixelsUseColors => ref UnsafeUtility.AsRef<bool>(&NativePtr->TexPixelsUseColors);
        ...
        public ref int PackIdMouseCursors => ref UnsafeUtility.AsRef<int>(&NativePtr->PackIdMouseCursors);
        public ref int PackIdLines => ref UnsafeUtility.AsRef<int>(&NativePtr->PackIdLines);
