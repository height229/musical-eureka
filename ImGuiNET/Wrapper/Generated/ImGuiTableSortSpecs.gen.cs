...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImGuiTableSortSpecsPtr
    {
        ...
        public ref int SpecsCount => ref UnsafeUtility.AsRef<int>(&NativePtr->SpecsCount);
        public ref bool SpecsDirty => ref UnsafeUtility.AsRef<bool>(&NativePtr->SpecsDirty);
        public void Destroy()
        {
