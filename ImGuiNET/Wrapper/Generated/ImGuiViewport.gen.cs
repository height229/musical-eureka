...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImGuiViewportPtr
    {
        ...
        public ref ImGuiViewportFlags Flags => ref UnsafeUtility.AsRef<ImGuiViewportFlags>(&NativePtr->Flags);
        public ref Vector2 Pos => ref UnsafeUtility.AsRef<Vector2>(&NativePtr->Pos);
        public ref Vector2 Size => ref UnsafeUtility.AsRef<Vector2>(&NativePtr->Size);
        ...
        public ref bool PlatformWindowCreated => ref UnsafeUtility.AsRef<bool>(&NativePtr->PlatformWindowCreated);
        public ref bool PlatformRequestMove => ref UnsafeUtility.AsRef<bool>(&NativePtr->PlatformRequestMove);
        public ref bool PlatformRequestResize => ref UnsafeUtility.AsRef<bool>(&NativePtr->PlatformRequestResize);
        public ref bool PlatformRequestClose => ref UnsafeUtility.AsRef<bool>(&NativePtr->PlatformRequestClose);
        public void Destroy()
        {
