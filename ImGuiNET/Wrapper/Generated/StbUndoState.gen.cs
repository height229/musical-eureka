...
namespace ImGuiNET
{
    ...
    public unsafe partial struct StbUndoStatePtr
    {
        ...
        public ref short undo_point => ref UnsafeUtility.AsRef<short>(&NativePtr->undo_point);
        public ref short redo_point => ref UnsafeUtility.AsRef<short>(&NativePtr->redo_point);
        public ref int undo_char_point => ref UnsafeUtility.AsRef<int>(&NativePtr->undo_char_point);
        public ref int redo_char_point => ref UnsafeUtility.AsRef<int>(&NativePtr->redo_char_point);
    }
}
