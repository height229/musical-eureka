...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImFontPtr
    {
        ...
        public ref short EllipsisCharCount => ref UnsafeUtility.AsRef<short>(&NativePtr->EllipsisCharCount);
        public ref float EllipsisWidth => ref UnsafeUtility.AsRef<float>(&NativePtr->EllipsisWidth);
        public ref float EllipsisCharStep => ref UnsafeUtility.AsRef<float>(&NativePtr->EllipsisCharStep);
